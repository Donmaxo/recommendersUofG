...
for n in [10]:
    ...
    # f = zipfile.ZipFile(os.path.join(data_path, f'nrms_rd_v4.3_{n}.zip'), 'w', zipfile.ZIP_DEFLATED)
    ...
    if not n: n = "all"
    f = zipfile.ZipFile(os.path.join(data_path, f'nrms_rd_v7_norm_{n}.zip'), 'w', zipfile.ZIP_DEFLATED)
